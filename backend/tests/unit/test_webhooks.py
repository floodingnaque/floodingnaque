...
module-level name has no effect.  Send the real test API key via
``api_headers`` fixture instead (from sample_data.py).
"""
...
class TestRegisterWebhook:
    ...
    def test_register_webhook_success(self, client, api_headers, valid_webhook_data, mock_db_session):
    ...
    def test_register_webhook_missing_url(self, client, api_headers):
    ...
    def test_register_webhook_missing_events(self, client, api_headers):
    ...
    def test_register_webhook_invalid_url(self, client, api_headers):
    ...
    def test_register_webhook_invalid_event(self, client, api_headers):
    ...
    def test_register_webhook_empty_events(self, client, api_headers):
    ...
    def test_register_webhook_with_custom_secret(self, client, api_headers, mock_db_session):
...
class TestListWebhooks:
    ...
    def test_list_webhooks_success(self, client, api_headers, mock_webhooks):
        ...
        with patch("app.api.routes.webhooks.get_db_session") as mock_session:
            ...
            response = client.get("/api/v1/webhooks/list", headers=api_headers)
    ...
    def test_list_webhooks_empty(self, client, api_headers):
...
class TestUpdateWebhook:
    ...
    def test_update_webhook_success(self, client, api_headers, mock_webhook):
    ...
    def test_update_webhook_not_found(self, client, api_headers):
    ...
    def test_update_webhook_invalid_url(self, client, api_headers, mock_webhook):
    ...
    def test_update_webhook_no_data(self, client, api_headers):
...
class TestDeleteWebhook:
    ...
    def test_delete_webhook_success(self, client, api_headers):
        ...
        with patch("app.api.routes.webhooks.get_db_session") as mock_session:
            ...
            response = client.delete("/api/v1/webhooks/1", headers=api_headers)

        assert response.status_code == 200
        data = response.get_json()
        assert "deleted successfully" in data["message"]

    def test_delete_webhook_not_found(self, client, api_headers):
        ...
        with patch("app.api.routes.webhooks.get_db_session") as mock_session:
            ...
            response = client.delete("/api/v1/webhooks/999", headers=api_headers)
...
class TestToggleWebhook:
    ...
    def test_toggle_webhook_enable(self, client, api_headers):
        ...
        with patch("app.api.routes.webhooks.get_db_session") as mock_session:
            ...
            response = client.post("/api/v1/webhooks/1/toggle", headers=api_headers)

        assert response.status_code == 200
        data = response.get_json()
        assert "is_active" in data

    def test_toggle_webhook_disable(self, client, api_headers):
    ...
    def test_toggle_webhook_not_found(self, client, api_headers):
        ...
        with patch("app.api.routes.webhooks.get_db_session") as mock_session:
            ...
            response = client.post("/api/v1/webhooks/999/toggle", headers=api_headers)
...
class TestWebhookEventTypes:
    ...
    def test_all_valid_events(self, client, api_headers):
...
class TestWebhookErrorHandling:
    ...
    def test_database_error_on_register(self, client, api_headers):
    ...
    def test_database_error_on_list(self, client, api_headers):
